...
/**
 * Spinny servlet runs a particular number of threads (specified in the URL field) 
 * where after each thread that is created, a delay will occur (also specified in the URL field)
 */
@WebServlet("/Spinny")
public class Spinny extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Extract the delay, final delay, and number of threads to create -- specified within the URL
...
class RunnableTask implements Runnable {
	...
	public void run() {
		while(!Spinny.finished) {
			...
			// Run a CPU intensive task -- Compute a large factorial OR the number of prime numbers in [0..n]
